...
# CONFIG_NAME = 'pose_hrnet_stable_w32_coco_256x192_v2'
CONFIG_NAME = 'pose_hrnet_stable_w32_coco_256x192_v2-2'
...
{"data.train.data_loader.batch_size": 4,
 ...
 "model.stable_loss.loss_weight": 0.5,
...
# PRETRAINED_PATH = './workspace/model_zoo/pose_models/hrnet_stable_w32_coco_256x192-experimental_stable(v2,mul2,bs32,wei0.5,noflip,epoch50)_20220611T124145.pth'
# PRETRAINED_DST_PREFIX = None
...
def main():
    ...
    parser.add_argument('--split-train-val', action='store_true', default=VAL_ANN_FILE is None)
