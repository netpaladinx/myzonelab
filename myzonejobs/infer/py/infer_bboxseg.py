...
def main(DATA_LABEL,
    ...
    ANN_FILE = f'{DATA_DIR}/annotations.json' if not ANN_FILE else f'{DATA_DIR}/{ANN_FILE}'
...
if __name__ == '__main__':
    ...
    #      CONFIG_NAME='bboxperson_deeplabv3_r50s8_coco_512x512',
    #      CHECKPOINT_PATH='./workspace/model_zoo/segmentation_models/bboxperson_deeplabv3_r50s8_coco_512x512-20220414_071957.pth')
    ...
    main(DATA_LABEL='MyZoneUFC-ReID_justin_noisy_val',
         DATA_DIR='./workspace/data_zoo/trainval/MyZoneUFC-ReID/MyZoneUFC-ReID_justin_noisy/val',
         CONFIG_NAME='bboxperson-pg_deeplabv3_r50s8_coco_512x512',
         CHECKPOINT_PATH='./workspace/model_zoo/segmentation_models/bboxperson-pg_deeplabv3_r50s8_coco_512x512-20220417_013131.pth',
         ANN_FILE='result_annotations_kpts-20220709T151140B.json')
    main(DATA_LABEL='MyZoneUFC-ReID_justin_noisy_train',
         DATA_DIR='./workspace/data_zoo/trainval/MyZoneUFC-ReID/MyZoneUFC-ReID_justin_noisy/train',
         CONFIG_NAME='bboxperson-pg_deeplabv3_r50s8_coco_512x512',
         CHECKPOINT_PATH='./workspace/model_zoo/segmentation_models/bboxperson-pg_deeplabv3_r50s8_coco_512x512-20220417_013131.pth',
